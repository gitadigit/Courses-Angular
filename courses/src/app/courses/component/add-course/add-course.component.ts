...
public selectedCategoryId!: number;
 ...
 private selectWayLearning!:number
  inputArray: string[] = [""];
...
public onSelectionWayLearningChanged(event:any){
  this.selectWayLearning=event.target.selectedIndex;
}
  ...
  public addCourse() {
    ...
    course.WayLearning=this.selectWayLearning
    console.log("ses",this.selectWayLearning)
